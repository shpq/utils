...
if __name__ == "__main__":
    ...
    with Pool(number) as p:
        ...
        df["paths"] = r
        df.to_csv("wild_gender_with_path.csv")
        df.to_pickle("wild_gender_with_path.pk")
